...
def atom37_from_rigid(rigid, generator=None):
    psi_pred = torch.rand(rigid.shape+(2,), generator=generator)
    bb_representations = compute_backbone(rigid, psi_pred)
    atom37 = bb_representations[0]
    return atom37
